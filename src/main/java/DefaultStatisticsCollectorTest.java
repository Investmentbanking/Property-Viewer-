...
public class DefaultStatisticsCollectorTest {
    ...
    public void getMostExpensiveBorough() {
        ...
        RuntimeDetails.setMaximumPrice(50);
        Statistics.reloadListings();
        String expected3 = "Kensington and Chelsea";
    ...
    public void getListingsWithReviews() {
        ...
        Statistics.reloadListings();
        int expected = 37438;
        int actual = DefaultStatisticsCollector.getListingsWithReviews();
        assertEquals(expected,actual);
        // the two largest valid options
        RuntimeDetails.setMinimumPrice(5000);
        Statistics.reloadListings();
        int expected2 = 3;
        int actual2 = DefaultStatisticsCollector.getListingsWithReviews();
        assertEquals(expected2, actual2);
        // two smallest options
        RuntimeDetails.setMinimumPrice(0);
        RuntimeDetails.setMaximumPrice(50);
        Statistics.reloadListings();
        int expected3 = 13117;
        int actual3 = DefaultStatisticsCollector.getListingsWithReviews();
        assertEquals(expected3, actual3);
    }
